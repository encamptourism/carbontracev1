...
const Contactus = (props) => {
  ...
  const submitDetails = async () => {
    ...
    if (
      enquiry.contact === "" ||
      enquiry.contact.length < 10 ||
      enquiry.contact.length > 13
    ) {
    ...
    if (!setter) {
      ...
      try {
        const localresponse = await adminapi.post(
          path,
    ...
    <>
      <div className={toggle ? "sidebar__area active" : "sidebar__area"}>
        <div className="sidebar__main__blk">
          ...
          <div className="sidebar__total__price mb-3"></div>
          <form action="">
            <div className="sidebar__form__wrap">
              ...
              <div className="sidebar__form__double">
                ...
                <textarea
                  rows={10}
                  className={error && error.message ? "error" : "dff"}
          ...
          <div className="sidebar__main__btn sidebar2">
            {issuccess ? (
              ...
              >
                Thank you for taking the step towards a sustainable future. Your
                submission has been received, and we will be in touch with you
                shortly.
                <br />
              </span>
            ) : (
            ...
            <button
              style={{ border: "none", width: "100%", marginTop: "2rem" }}
